...
#define PV_CPU_usergs_sysret64 256 /* offsetof(struct paravirt_patch_template, cpu.usergs_sysret64) */
#define PV_CPU_swapgs 272 /* offsetof(struct paravirt_patch_template, cpu.swapgs) */
...
#define TASK_threadsp 4888 /* offsetof(struct task_struct, thread.sp) */
#define TASK_stack_canary 2248 /* offsetof(struct task_struct, stack_canary) */

#define TASK_addr_limit 5016 /* offsetof(struct task_struct, thread.addr_limit) */
...
#define PV_IRQ_irq_disable 312 /* offsetof(struct paravirt_patch_template, irq.irq_disable) */
#define PV_IRQ_irq_enable 320 /* offsetof(struct paravirt_patch_template, irq.irq_enable) */
#define PV_CPU_iret 264 /* offsetof(struct paravirt_patch_template, cpu.iret) */
#define PV_MMU_read_cr2 392 /* offsetof(struct paravirt_patch_template, mmu.read_cr2) */
